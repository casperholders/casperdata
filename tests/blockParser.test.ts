...
describe('Test blockParser class', () => {
  ...
  it('Should retrieve a block', async () => {
    ...
    const blockParser = new BlockParser(casperClient, new CasperServiceByJsonRPC('http://176.9.125.5:7777/rpc'), new DeployParser(casperClient, deploys, config), new Blocks(), deploys, config);
